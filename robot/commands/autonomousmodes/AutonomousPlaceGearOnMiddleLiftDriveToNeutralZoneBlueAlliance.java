...
public class AutonomousPlaceGearOnMiddleLiftDriveToNeutralZoneBlueAlliance extends CommandGroup {	
    public AutonomousPlaceGearOnMiddleLiftDriveToNeutralZoneBlueAlliance(DriveTrain driveTrain, GearCarriage gearCarriage, Lighting carriageStalledLighting, Lighting carriageExtendedLighting) {
    	...
    	// Drive to wall -> turn -> drive to neutral zone
